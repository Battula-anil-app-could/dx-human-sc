...
use dharitri_sc_scenario::{
    managed_address, managed_biguint, managed_buffer, dharitri_chain_vm::tx_mock::TxContextRef,
    rust_biguint,
};
...
fn test_job_setup() {
    ...
    blockchain_wrapper.set_dct_balance(owner_address, OTHER_TOKEN, &rust_biguint!(100u64));
    blockchain_wrapper
        .execute_tx(
            owner_address,
            &contract_wrapper,
...
fn test_job_cancel() {
    ...
    blockchain_wrapper.set_dct_balance(owner_address, HMT_TOKEN, &rust_biguint!(100u64));
    blockchain_wrapper
    ...
    let current_balance = blockchain_wrapper.get_dct_balance(owner_address, HMT_TOKEN, 0);
